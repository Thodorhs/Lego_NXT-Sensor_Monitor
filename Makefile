...
PREFIX=../lego-toolchain_23-master
...
# Files
########################################################################
SRC  += aic.c pit.c display.c Cstartup_SAM7.c led.c i2c.c spi.c sound.c hwinit.c aclock.c output.c button.c input.c $(TARGET).c
ASRC  = Cstartup.S 
COBJ  = $(SRC:.c=.o) 
AOBJ  = $(ASRC:.S=.o)
